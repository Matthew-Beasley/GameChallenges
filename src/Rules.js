  ...
  return (
    <div id="about-container">
      ...
      <div id="about-plate">
        ...
        <p>Once you’re in the game, enter each player’s name, and choose any filters to narrow down which of your decka you want to play.  Your first challenge will be displayed.  You’ll know whose turn it is because their avatar in the navigation bar will be elevated.  When the challenge is over, the player enters whether or not they were successful.  The score will appear on the scoreboard and then the next player’s avatar will jump up.</p>
      </div>
    </div>
  );
};
